...
<div class="flex-col items-center justify-center py-4 px-4">
  <h1 class="text-4xl font-bold mt-4">
    Shared Element Transitions in SvelteKit
  </h1>
  ...
  <p class="mt-4 text-xl">
    ...
    >. Only works in Chrome Canary with the documentTransition API flag enabled
    and may break at any time due to the API changing.
  </p>
</div>
